          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  $i = 1; 
                  $queryInvoice = $conn->query("SELECT invoice_pembelian.invoice_pembelian_id ,invoice_pembelian.pembelian_invoice, invoice_pembelian.invoice_tgl, supplier.supplier_id, supplier.supplier_nama, supplier.supplier_company, invoice_pembelian.invoice_total, invoice_pembelian.invoice_bayar, invoice_pembelian.invoice_kembali, user.user_id, user.user_nama
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: 20%;">
                      <?php $id = $rowProduct['invoice_pembelian_id']; ?>
                        ...
                        <a href="pembelian-delete-invoice?id=<?= $rowProduct['pembelian_invoice']; ?>" onclick="return confirm('Apakah Anda Yakin Hapus Seluruh Data No. Invoice <?= $rowProduct['pembelian_invoice']; ?> ?')" title="Delete Invoice">
