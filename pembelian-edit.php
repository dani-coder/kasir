              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    $total = 0;
	                  $i = 1; 
	                  $queryProduct = $conn->query("SELECT pembelian.pembelian_id, barang.barang_id, barang.barang_nama, pembelian.barang_harga_beli, barang.barang_stock, pembelian.barang_qty, pembelian.pembelian_invoice,  pembelian.barang_qty_lama
	                             FROM pembelian 
