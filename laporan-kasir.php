                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select2bs4" required="" name="user_id">
                            ...
                            <?php  
                              $user = query("SELECT * FROM user WHERE user_status = '1' ORDER BY user_id DESC ");
                            ?>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  $i = 1; 
                  $total = 0;
                  $queryInvoice = $conn->query("SELECT invoice.invoice_id ,invoice.penjualan_invoice, invoice.invoice_tgl, user.user_id, user.user_nama, invoice.invoice_total
                             FROM invoice 
