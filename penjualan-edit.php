          ...
          <div class="col-12">
            <div class="callout callout-info">
              <h5><i class="fas fa-info"></i> Note:</h5>
				      Jika terjadi kesalahan dalam transaksi penjulan barang bisa melakukan Edit QTY atau HAPUS barang di halaman ini. Anda <b>WAJIB MENYELESAIKAN TRANSAKSI</b> Invoice saat masuk halaman ini
            </div>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    $total = 0;
	                  $i = 1; 
	                  $queryProduct = $conn->query("SELECT penjualan.penjualan_id, barang.barang_id, barang.barang_nama, barang.barang_harga, barang.barang_stock, penjualan.barang_qty, penjualan.penjualan_invoice,  penjualan.barang_qty_lama
	                             FROM penjualan 
                    ...
                    <tr>
                      ...
                      <td style="text-align: center; width: 11%;">
                        <form role="form" action="" method="post">
                          ...
                          <input type="number" min="1" name="barang_qty" value="<?= $rowProduct['barang_qty']; ?>" onkeypress="return hanyaAngka(event)" style="text-align: center; width: 60%;"> 
